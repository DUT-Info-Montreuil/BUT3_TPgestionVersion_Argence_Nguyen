...
public class QuestLine {
    ...
    public QuestLine(Joueur j){
        ...
        quetes.add(new TalkQuete("Chapitre 0 - Que fait on aussi tard avec un jour de retard?", "On est determiné ! on va faire du mieux su'on peut monsieur ! soyez gentil :)", 10, "Potion", 1, "spectre"));
